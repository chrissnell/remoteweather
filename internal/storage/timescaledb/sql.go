...
const createSnowSimplePositiveDeltaSQL = `-- Simple positive delta sum for hourly aggregates (seasonal calculation)
-- Uses weather_1h instead of weather_1d to ensure data availability and logical ordering
