...
// Aeris Weather alerts table
const createAerisWeatherAlertsTableSQL = `CREATE TABLE IF NOT EXISTS aeris_weather_alerts (
...
COMMENT ON TABLE aeris_weather_alerts IS
'Weather alerts from Xweather/Aeris Weather API. Refreshed every 15 minutes per device.
Alerts expired more than 24 hours are automatically cleaned up daily.';`
